module Spree
  class PayuController < ApplicationController
    ...
    def index
      @surl = payu_confirm_url
      @furl = payu_cancel_url
    ...
    def confirm
      ...
      payment = order.payments.create!({
        source_type: 'Spree::Gateway::Payu',#could be something generated by system
        amount: order.total,
    ...
    def cancel
      ...
      Spree::LogEntry.create({
        source: 'Spree::Gateway::Payu',
        details: params.to_yaml
      })
      
      flash[:notice] = "Don't want to use Payu? No problems."
